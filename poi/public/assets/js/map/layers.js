...
export function installSourcesAndLayers(map) {
    ...
    addLayer({
        ...
        paint: {
            'line-color': [
                'case',
                ['==', ['get', 'status'], 'closed'], ROUTE_COLORS.closed,
                MAP_COLORS.road
            ],
            'line-width': ['interpolate', ['linear'], ['zoom'], 13, 1, 17, MAP_LAYER_STYLES.road.width],
            'line-opacity': MAP_LAYER_STYLES.road.opacity
        }
    });
    addLayer({
        id: layers.routeOld,
